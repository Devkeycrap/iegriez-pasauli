    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wheel_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.wheeloffortune')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='map',
            name='wheel_fk',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.wheeloffortune'),
        ),
    ]
